...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/twitterscreendevice.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/twitterscreendevice ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/LCDControl.o: LCDControl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LCDControl.o LCDControl.cpp
...
${OBJECTDIR}/TweetHandler.o: TweetHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TweetHandler.o TweetHandler.cpp
